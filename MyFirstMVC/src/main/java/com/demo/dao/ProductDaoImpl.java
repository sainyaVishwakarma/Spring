...
public class ProductDaoImpl implements ProductDao{
	...
	public int save(Product p) {
		// TODO Auto-generated method stub
		return jdbcTemplate.update("insert into prod values(?,?,?,?)",new Object[] {p.getPid(),p.getPname(),p.getQty(),p.getPrice()});
	}
	...
	public int updateProduct(Product p) {
		// TODO Auto-generated method stub
		return jdbcTemplate.update("update prod set pname=?,qty=?,price=? where pid=?",new Object[] {p.getPname(),p.getQty(),p.getPrice(),p.getPid()});
	}
}
